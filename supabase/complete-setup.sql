-- Complete Database Setup for World Cup Predictor with Enhanced Scoring
...
-- Create group predictions table
...
-- Create knockout predictions table
...
-- Create user points tracking with enhanced scoring
...
-- Create prediction predictions table (users predicting other users' predictions)
...
-- Function to calculate user points with enhanced scoring
...
-- Users can view leagues they're in
...
-- Users can view league members for their leagues
...
-- Users can view match results (public within app)
...
-- - League management
-- - Group and knockout predictions
-- - Enhanced scoring system (5/2/1 points)
-- - Prediction predictions (3 points for predicting others' predictions)
-- - Full RLS security
